...
function configureMenuRoutes(app: Express) {
    ...
    */
    ...
    app.post(`/${process.env.BASE_URL_API}/menu`, menuCtrl.insertCtrl);
    app.put(`/${process.env.BASE_URL_API}/menu/:mnu_uuid`, menuCtrl.updateCtrl);
    app.delete(`/${process.env.BASE_URL_API}/menu/:mnu_uuid`, menuCtrl.deleteCtrl);
}
